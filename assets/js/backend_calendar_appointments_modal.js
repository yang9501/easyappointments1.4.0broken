    ...
    function bindEventHandlers() {
        ...
        $('#manage-appointment #save-appointment').on('click', function () {
            ...
            var appointment = {
                ...
                question1: $dialog.find('#appointment-question1').val(),
                question2: $dialog.find('#appointment-question2').val(),
                question3: $dialog.find('#appointment-question3').val(),
                question4: $dialog.find('#appointment-question4').val(),
                question5: $dialog.find('#appointment-question5').val(),
