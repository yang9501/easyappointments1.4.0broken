...
(function (exports) {
    ...
    function applyAppointmentData(appointment, provider, customer) {
        try {
            ...
            var appointmentQuestion1 = (appointment.question1 !== null)
                ? appointment.question1 : '';
            $('#question1').val(appointmentQuestion1);
            var appointmentQuestion2 = (appointment.question2 !== null)
                ? appointment.question2 : '';
            $('#question2').val(appointmentQuestion2);
            var appointmentQuestion3 = (appointment.question3 !== null)
                ? appointment.question3 : '';
            $('#question3').val(appointmentQuestion3);
            var appointmentQuestion4 = (appointment.question4 !== null)
                ? appointment.question4 : '';
            $('#question4').val(appointmentQuestion4);
            var appointmentQuestion5 = (appointment.question5 !== null)
                ? appointment.question5 : '';
            $('#question5').val(appointmentQuestion5);
