                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="appointment-question2" class="control-label"><?= lang('question2') ?></label>
                                    <textarea id="appointment-question2" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="appointment-question4" class="control-label"><?= lang('question4') ?></label>
                                    <textarea id="appointment-question4" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="appointment-question1" class="control-label"><?= lang('question1') ?></label>
                                    <textarea id="appointment-question1" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="appointment-question3" class="control-label"><?= lang('question3') ?></label>
                                    <textarea id="appointment-question3" class="form-control" rows="3"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="appointment-question5" class="control-label"><?= lang('question5') ?></label>
                                    <textarea id="appointment-question5" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
