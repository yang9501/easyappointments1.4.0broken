                    ...
                    <div class="row frame-content">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="question1" maxlength="500" class="form-control" rows="1"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="question3" class="control-label">
                                    <?= lang('question3') ?>
                                </label>
                                <textarea id="question3" maxlength="500" class="form-control" rows="1"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="question5" class="control-label">
                                    <?= lang('question5') ?>
                                </label>
                                <textarea id="question5" maxlength="500" class="form-control" rows="1"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="question2" maxlength="500" class="form-control" rows="1"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="question4" class="control-label">
                                    <?= lang('question4') ?>
                                </label>
                                <textarea id="question4" maxlength="500" class="form-control" rows="1"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
