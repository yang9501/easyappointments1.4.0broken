...
class Appointments extends EA_Controller {
    ...
    public function book_success($appointment_hash)
    {
        ...
        unset($appointment['question1']);
        unset($appointment['question2']);
        unset($appointment['question3']);
        unset($appointment['question4']);
        unset($appointment['question5']);
     ...
     *
     * This method will return the database ID of all the providers with the most available.
     *
