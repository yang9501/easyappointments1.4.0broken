...
class Appointments implements ParsersInterface {
    ...
    public function decode(array &$request, array $base = NULL)
    {
        ...
        {
            $decoded_request['question1'] = $request['question1'];
        }

        if ( ! empty($request['question2']))
        {
            $decoded_request['question2'] = $request['question2'];
        }

        if ( ! empty($request['question3']))
        {
            $decoded_request['question3'] = $request['question3'];
        }

        if ( ! empty($request['question4']))
        {
            $decoded_request['question4'] = $request['question4'];
        }

        if ( ! empty($request['question5']))
        {
            $decoded_request['question5'] = $request['question5'];
        }
